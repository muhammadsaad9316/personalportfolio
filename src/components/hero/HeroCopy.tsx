...
export default function HeroCopy() {
  return (
    <div className={styles.copy} data-hero-fade data-exit="up">
      <div className={styles.layer} data-depth="0.22" data-side="design" data-quiet="0.16">
        ...
        <p className={styles.lede} data-reveal="copy">
          I turn ideas into intuitive interfaces and powerful products that make
          an impact.
        </p>
